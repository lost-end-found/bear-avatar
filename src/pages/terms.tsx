    ...
    <PageContainer>
      ...
      >
        <Text fontWeight="bold" fontSize="3xl">
          AIvatar Privacy Policy
        </Text>

        <Text>
          It is AIvatar&#39;s policy to respect your privacy and comply with
          ...
          <Link textDecoration="underline" href="https://aivatar.studio/">
            https://aivatar.studio/
          </Link>
        ...
        <Text>
          By accessing and using AIvatar, you are also using the Replicate
        ...
        <Text>
          ...
          <Link href="mailto:hello@aivatar.studio">hello@aivatar.studio</Link>. Please
        ...
        <Text>
          ...
          <Link href="mailto:hello@aivatar.studio">hello@aivatar.studio</Link>
        </Text>
      </VStack>
    </PageContainer>
  );
